...
release_url=https://github.com/magikcypress/personal-root-website-vuepress.git

if [ -d "/home/ipfs/personal-root-website-vuepress" ]
then
    cd /home/ipfs/personal-root-website-vuepress/
    git pull
else
    echo -e "\e[32m>> Downloading git repo ...\e[0m"
    git clone ${release_url}
    cd /home/ipfs/personal-root-website-vuepress/docs
    npm install
    yarn build
fi
